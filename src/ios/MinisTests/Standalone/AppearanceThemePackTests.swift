...
check("theme library file", Path("/var/minis/workspace/OpenMinis/src/ios/Shared/AppearanceThemeLibrary.swift").read_text().contains("appearanceStudio.themeLibrary.v1"))
check("save current", Path("/var/minis/workspace/OpenMinis/src/ios/Shared/AppearanceThemeLibrary.swift").read_text().contains("func saveCurrentTheme"))
check("cli save", offload.contains("cmd_save"))
check("cli use", offload.contains("cmd_use"))
check("studio library section", Path("/var/minis/workspace/OpenMinis/src/ios/Views/Settings/AppearanceStudioView.swift").read_text().contains("主题库"))
