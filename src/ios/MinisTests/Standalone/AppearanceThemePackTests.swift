...
check("user bubble uses pack", chat.contains("MinisThemeShape.userBubbleRadius"))
check("assistant bubble uses pack", think.contains("MinisThemeShape.assistantBubbleRadius"))
